...
#[ORM\Entity(repositoryClass: TVoteVicepresidentRepository::class)]
class TVoteVicepresident
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\Column]
    private ?int $DIAWARA_Yassa = null;
    ...
    public function getDIAWARAYassa(): ?int
    {
        return $this->DIAWARA_Yassa;
    }

    public function setDIAWARAYassa(int $DIAWARA_Yassa): static
    {
        $this->DIAWARA_Yassa = $DIAWARA_Yassa;
